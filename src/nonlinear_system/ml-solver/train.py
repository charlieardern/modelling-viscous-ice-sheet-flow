...
from models import SimpleNeuralField
...
print(f"req grad: {s_t0.requires_grad}")
...
model = SimpleNeuralField(hidden_dim=64)
...
for epoch in tqdm(range(epochs)):
    ...
    boundary_0_values = model(boundary_0)
    ...
    loss = mse_f + boundary_0_err + boundary_L_err + s_0_mse
    print(f"loss: {loss}")
