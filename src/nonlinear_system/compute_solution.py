...
a = 0.5
num_t_steps = 100
num_microsteps = 10000 # Number of steps to compute per time step (true time step=num_t_steps*num_microsteps)
t_final = 10
dim = 200
w = L/dim
g = 9.81
...
np.save("saved_objects/numerical_solution_fd.npy", h_num_fd)
np.save("saved_objects/numerical_solution_fv.npy", h_num_fv)