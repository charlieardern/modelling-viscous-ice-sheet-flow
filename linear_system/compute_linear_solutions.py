...
from numerical import compute_numerical
...
h_num = compute_numerical(h_0, num_microsteps, num_t_steps, t_final, dim, L, h_G, a, k)
...
np.save("saved_objects/linear_numerical_solution.npy", h_num)